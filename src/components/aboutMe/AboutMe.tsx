    ...
    <section className="w-full h-[100vh] bg-[url(/images/background2.png)]">
      <div className="max-w-[1300px] h-full mx-auto py-[12vh] flex justify-between">
          ...
          <div>
            ...
            <ul>
              {SUBTITLES.map((subTitle) => {
                return (
                  <li key={subTitle}>
                    <p className="title-22-regular mb-[10px] text-[#ccc]">
                      {subTitle}
                    </p>
                  </li>
                );
        ...
        <div className="w-[60%] flex justify-end items-end">
          <FadeInView className="text-20-extraLight !leading-[36px] break-keep" delay={0.4}>
            ...
            당연히 보여야 할 화면과 흐름을 고민하며, 직관적인 인터페이스를
            지향하려고 노력하고 있습니다.
          </FadeInView>
        </div>
      </div>
