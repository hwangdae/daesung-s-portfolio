...
export const PROJECTS = [
  {
    ...
    preview: [
      { id: 1, src: WaitHome, title: "웨이팅 메인화면" },
      { id: 2, src: WaitDetail, title: "주점 상세" },
      { id: 3, src: WaitPartysize, title: "웨이팅 인원 선택" },
      { id: 4, src: WaitSummary, title: "웨이팅 요약" },
      { id: 5, src: WaitSuccess, title: "웨이팅 완료" },
      { id: 6, src: Map, title: "축제 맵" },
      { id: 7, src: Home, title: "주문 메인화면" },
      { id: 8, src: MenuDetail, title: "주문 상세" },
      { id: 9, src: PayButton, title: "메뉴 추가 시" },
      { id: 10, src: Cart, title: "장바구니" },
      { id: 11, src: Remittance, title: "결제" },
      { id: 12, src: RemittanceWait, title: "결제 대기" },
      { id: 13, src: OrderSuccess, title: "결제 완료" },
      { id: 14, src: OrderDetails, title: "주문 내역" },
    ],
    tags: ["팀", "사이드"],
