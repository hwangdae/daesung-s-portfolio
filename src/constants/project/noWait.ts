export const NOWAIT_DETAIL = {
  ...
  works: [
    ...
    },
    {
      ...
      description: [
        "이 문제를 해결하기 위해 <strong>JavaScript의 Image 객체를 활용해 애니메이션 이미지를 비동기적으로 로드</strong>하고, <strong>로드 완료 전까지는 가벼운 정적 이미지를 fallback 이미지로 표시하도록 구현</strong>했습니다. <strong>애니메이션 이미지가 완전히 로드되면 자연스럽게 교체되도록 하여, 공백 구간을 제거하고 화면 완성도를 높여 UX를 개선</strong>했습니다.",
      ],
    },
    {
