export const NOWAIT_DETAIL = {
  ...
  works: [
    ...
    },
    {
      ...
      thinking: [
        "1. 축제 맵을 만들 때 가장 중요하게 생각했던 건, 사용자가 원하는 주점 위치를 최대한 빠르고 정확하게 찾을 수 있게 하는 것이었습니다. 처음에는 문서가 잘 되어 있고 기능도 편하게 쓸 수 있는 카카오 지도 API를 사용 했지만, 주점들이 워낙 좁은 공간에 몰려 있어서 카카오 지도 줌 레벨로는 정확한 좌표를 찍는 데 한계가 있었고, 사용자 측면에서 정확한 위치를 파악하는데 어려움이 있었습니다.",
        "2. 대학교 축제 특성상 주점 위치가 명확하게 정해져 있지 않아 직접 좌표를 찾아 등록해야 했습니다. 이 과정이 너무 비효율적이라고 느껴졌고, 운영 측면에서도 개선이 필요하다고 판단했습니다.",
      ],
      description: [
    ...
    },
    {
      ...
      thinking: [
        "GIF 파일을 WebP로 변환했음에도 용량이 예상보다 커, 페이지 진입 시 텍스트는 먼저 렌더링되지만 이미지 로딩이 지연되는 현상이 발생했습니다. 그 결과 한동안 텍스트만 표시되어 화면이 완성되지 않은 듯한 인상을 주었고, 사용자가 의도된 레이아웃을 즉시 인지하지 못해 전체적인 UX가 다소 어색하게 느껴졌습니다.",
      ],
      description: [
